...
# ── Free AI Image APIs (priority order) ─────────────────────
# 1. Hugging Face Inference API — SDXL, Flux, etc (FREE with key)
# 2. Stable Horde — community GPUs (FREE, no key needed)
# 3. Pollinations — fallback

HF_API_KEY   = os.getenv("HF_API_KEY", "")          # hf_... from huggingface.co/settings/tokens
HORDE_APIKEY = os.getenv("HORDE_APIKEY", "0000000000") # or register at stablehorde.net
